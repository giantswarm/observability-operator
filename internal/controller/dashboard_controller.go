...
func SetupDashboardReconciler(mgr manager.Manager, environment config.Environment) error {
...
func getDashboardCMOrg(dashboard *v1.ConfigMap) (Org string, err error) {
	...
	orgLabel := dashboard.GetLabels()[DashboardTeamAnnotation]
...
func (r DashboardReconciler) configureDashboard(ctx context.Context, dashboardCM *v1.ConfigMap) (err error) {
	...
	// WARNING: changes global grafanaAPI context, conflicts with other reconcilers!
	//defer func() {
