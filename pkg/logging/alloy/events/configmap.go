...
func (a *Service) generateAlloyEventsConfig(
	...
	data := struct {
		...
		MaxBackoffPeriod:   lokiMaxBackoffPeriod,
		RemoteTimeout:      lokiRemoteTimeout,
		...
		LoggingURLKey:      lokiURLKey,
		LoggingTenantIDKey: lokiTenantIDKey,
		LoggingUsernameKey: lokiUsernameKey,
		LoggingPasswordKey: lokiPasswordKey,
