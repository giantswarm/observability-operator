...
const (
	...
	vmRemoteWriteAPINameKey     = "vmRemoteWriteAPIName"
	vmRemoteWriteAPIURLKey      = "vmRemoteWriteAPIURL"
	vmRemoteWriteAPIUsernameKey = "RemoteWriteAPIUsername"
	vmRemoteWriteAPIPasswordKey = "RemoteWriteAPIPassword" // #nosec G101
)
