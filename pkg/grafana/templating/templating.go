...
func GenerateGrafanaConfiguration(organizations []v1alpha1.GrafanaOrganization) (string, error) {
	...
	orgMappings = append(orgMappings, buildOrgMapping("giantswarm-ad:giantswarm-admins", grafana.SharedOrg.Name, grafanaAdminRole))
	orgMappings = append(orgMappings, buildOrgMapping("giantswarm-github:giantswarm:giantswarm-admins", grafana.SharedOrg.Name, grafanaAdminRole))
