...
func (s *Service) generateAlloyEventsConfig(
	...
	data := struct {
		...
		MimirRemoteWriteUsernameKey string
		MimirRemoteWritePasswordKey string
		OTLPLogsEnabled             bool
		...
		MimirRemoteWriteUsernameKey: common.MimirRemoteWriteAPIUsernameKey,
		MimirRemoteWritePasswordKey: common.MimirRemoteWriteAPIPasswordKey,
